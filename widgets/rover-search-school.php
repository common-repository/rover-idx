...
class roveridx_search_school extends WP_Widget 
	...
	function form($instance) { 
		...
		<aside>
			...
			<p><label for="<?php echo $this->get_field_id('school_label'); ?>">Text Label: <input class="widefat" id="<?php echo $this->get_field_id('school_label'); ?>" name="<?php echo $this->get_field_name('school_label'); ?>" type="text" value="<?php echo esc_attr($school_label); ?>" /></label></p>
